package com.ifba.microserviceaudit.api
...
object MicroserviceAuditService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The Microservice - Audit service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MicroserviceAuditService.
  */
trait MicroserviceAuditService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("microservice---audit")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(MicroserviceAuditService.TOPIC_NAME, greetingsTopic _)
